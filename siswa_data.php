...
?>
      ...
      <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="siswa_data.php"><i class="fa fa-users"></i> Daftar Siswa</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              ...
              <div class="col-md-3">
                <span class="box-title"> Daftar Siswa </span>
                <a class='btn btn-xs  btn-success' href="siswa_tambah.php"><i class ='fa fa-plus'></i> Tambah Siswa </a>
              </div>
              <!-- <div class="col-md-4">
                <span class="box-title"> Import Data Siswa </span>
                <a class='btn btn-xs  btn-success' href="import_data/data_siswa/form.php" target="_blank"><i class ='fa fa-plus'></i> Tambah import </a>
              </div> -->
              <div class="col-md-4">
                <span class="box-title"> Export Data Siswa </span>
                <a class='btn btn-xs  btn-success' href="export_data/data_siswa/export_data.php" target="_blank"><i class ='fa fa-plus'></i> Export data siswa </a>
              </div>
            </div>
            ...
            <div class="box-body ">
              ...
              <?php
              $sql="SELECT * FROM as_siswa as s INNER JOIN as_kelas as k ON s.id_kelas=k.id_kelas ORDER BY nis ASC ";
              ...
              $tbl= " ";
                 ...
                 if (mysqli_num_rows($sql_h) > 0) {
                   ...
                   foreach ($sql_h as $key => $value) {
                     ...
                     $tbl.= "<td>".$nomor."</td>";
                     $tbl.= "<td>
                    <a class='btn btn-xs btn-primary' href='siswa_detail.php?id_siswa=".$value['id_siswa']."'><i class='fa fa-eye'></i></a>
                    <a class='btn btn-xs btn-warning' href='siswa_edit.php?id_siswa=".$value['id_siswa']."'><i class='fa fa-edit'></i></a>
                    <a class='btn btn-xs btn-danger' href='javascript:hapus(".$value['id_siswa'].")'><i class='fa fa-trash'></i></a></td>";
                     $tbl.= "<td>".$value['nis']."</td>";
...
function hapus(id_siswa){
  if(confirm("yakin ingin menghapus data ini !!")) {
    window.location.href="siswa_hapus.php?id_siswa=" + id_siswa;
  }
}
</script>
<script>
