      ...
      <li class="treeview">
        ...
        <li class="active treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="sms_kirim.php"><i class="fa fa-send"></i>Kirim Pesan  </a></li>
            </ul>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Sms Kirim</a></li>
      </ol>
    </section>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li ><a href="sms_keluar.php"><i class="fa fa-envelope-o"></i> Pesan Keluar</a></li>
                  <li class="active"><a href="sms_kirim.php"><i class="fa fa-file-text-o"></i> Kirim Pesan</a></li>
            ...
            <form role="form" action="" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="no" class="form-control" id="exampleInputEmail1" placeholder="Enter NOhp">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Pesan</label>
                  <!-- <input type="password"  id="exampleInputPassword1" placeholder="Password"> -->
                  <textarea name="textpesan"  class="form-control" placeholder="isi pesan"></textarea>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" name="sub" class="btn btn-primary">Kirim</button>
              </div>
            </form>
...
if (isset($_POST['sub'])) {
  ...
  $query ="INSERT INTO inbox (DestinationNumber, SenderID, TextDecoded, CreatorID) 
  VALUES ('$no', '$ID', '$pesan ', 'Gammu .128.90')";
    $sqll =mysqli_query($conn,$query);
?>
<script type="text/javascript">alert("berhasil di kirim")</script>
...
<script language="JavaScript" type="text/javascript">
      function hapus(ID){
        if (confirm("Apakah anda yakin akan menghapus data ini?")){
          window.location.href = 'sms_masuk_hapus.php?ID=' + ID;
        }
      }
    </script>
<!-- ./wrapper -->
